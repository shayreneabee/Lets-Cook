...
const regionalSoulFoodPages = {
  "mississippi-soul-food": {
    ...
    signatureRecipeIds: ["fried-catfish", "mississippi-buffalo-fish", "mississippi-perch-fry", "mississippi-bream-fry", "mississippi-crappie-fry", "mississippi-fish-fry-plate", "comeback-sauce", "hot-water-cornbread", "smothered-pork-chops", "southern-collard-greens", "peach-cobbler", "caramel-cake"],
  ...
  "louisiana-soul-food": {
    ...
    signatureRecipeIds: ["cajun-chicken-sausage-gumbo", "cajun-shrimp-etouffee", "cajun-jambalaya", "shrimp-poboy", "oyster-poboy", "muffuletta", "charbroiled-oysters", "crawfish-boil", "cajun-dirty-rice", "creole-seafood-gumbo", "beignets", "bourbon-praline-bread-pudding"],
  ...
  "tennessee-soul-food": {
    ...
    signatureRecipeIds: ["nashville-hot-chicken", "memphis-dry-rub-ribs", "memphis-bbq-spaghetti", "bbq-pulled-pork", "southern-potato-salad", "creamy-coleslaw", "banana-pudding", "sweet-tea"],
  ...
  "texas-soul-food": {
    ...
    signatureRecipeIds: ["bbq-brisket-basics", "texas-beef-ribs", "texas-smoked-sausage", "jalapeno-cheddar-sausage", "texas-chili", "bbq-chicken-quarters", "bbq-baked-beans", "cornbread", "watermelon-platter", "red-velvet-cake", "strawberry-soda"],
  ...
  "florida-soul-food": {
    ...
    signatureRecipeIds: ["florida-blue-crab", "stone-crab-claws", "grouper-sandwich", "smoked-mullet", "cuban-sandwich", "key-lime-pie", "lemonade", "cucumber-salad", "watermelon-platter"],
  ...
  "north-carolina-soul-food": {
    ...
    signatureRecipeIds: ["eastern-nc-bbq", "lexington-bbq", "creamy-coleslaw", "cornbread", "fried-chicken", "southern-collard-greens", "banana-pudding", "sweet-tea"],
  ...
  "virginia-soul-food": {
    ...
    signatureRecipeIds: ["virginia-country-ham", "virginia-brunswick-stew", "virginia-peanut-soup", "smothered-pork-chops", "fried-chicken", "southern-collard-greens", "cornbread", "peach-cobbler", "buttermilk-biscuits", "sweet-tea"],
...
const regionalMenuOverrides = {
  "mississippi-soul-food": [
    { id: "fish-fry", title: "Mississippi Fish Fry", recipeIds: ["mississippi-fish-fry-plate", "fried-catfish", "mississippi-buffalo-fish", "mississippi-perch-fry", "mississippi-crappie-fry", "comeback-sauce", "hot-water-cornbread", "creamy-coleslaw", "southern-potato-salad", "sweet-tea", "peach-cobbler"], timeline: ["Morning: cut fish, mix slaw, and chill drinks.", "One hour before: season fish, heat oil, and set racks.", "Serve: fry fish in batches and keep sides cold."], notes: "Build the plate around hot cornmeal-crusted fish, cold sides, comeback sauce, hot sauce, lemon, bread, and plenty of napkins." },
  ...
  "louisiana-soul-food": [
    ...
    { id: "new-orleans-table", title: "New Orleans Table", recipeIds: ["shrimp-poboy", "oyster-poboy", "muffuletta", "charbroiled-oysters", "beignets", "lemonade"], timeline: ["Day before: make olive salad and sauces.", "One hour before: prep shrimp, oysters, and sandwich fillings.", "Serve: fry seafood last and cut muffuletta into wedges."], notes: "This menu should feel portable, festive, briny, and good for second-line energy." },
    { id: "crawfish-boil", title: "Backyard Crawfish Boil", recipeIds: ["crawfish-boil", "corn-maque-choux", "french-bread", "beignets", "sweet-tea"], timeline: ["Morning: purge crawfish and stage potatoes, corn, sausage, and lemons.", "One hour before: bring the boil pot to a rolling boil.", "Serve: drain, spread the table, and keep drinks cold."], notes: "A crawfish boil is a whole-table event: seafood, seasoning, music, newspaper, napkins, and people standing around the pot." },
  ...
  "florida-soul-food": [
    { id: "coastal-seafood-table", title: "Florida Coastal Seafood Table", recipeIds: ["florida-blue-crab", "stone-crab-claws", "grouper-sandwich", "smoked-mullet", "cucumber-salad", "lemonade", "key-lime-pie"], timeline: ["Morning: chill crab and make sauce.", "One hour before: prep salad, sandwiches, and drinks.", "Serve: keep seafood cold, press or fry sandwiches hot, and keep dessert chilled."], notes: "Florida seafood menus need crab, fish, citrus, crisp sides, cold drinks, and light desserts." },
  ...
  "north-carolina-soul-food": [
    { id: "eastern-bbq", title: "Eastern North Carolina BBQ Plate", recipeIds: ["eastern-nc-bbq", "creamy-coleslaw", "cornbread", "southern-collard-greens", "banana-pudding", "sweet-tea"], timeline: ["Day before: season pork and prep slaw.", "Morning: smoke or roast pork low and slow.", "Serve: chop pork, dress with vinegar sauce, and keep slaw cold."], notes: "Eastern North Carolina should taste like chopped pork, vinegar-pepper sauce, slaw, greens, bread, and tea." },
    { id: "lexington-plate", title: "Lexington BBQ Plate", recipeIds: ["lexington-bbq", "creamy-coleslaw", "bbq-baked-beans", "cornbread", "peach-cobbler", "sweet-tea"], timeline: ["Day before: make slaw and dessert.", "Morning: cook pork shoulder.", "Serve: chop pork, pass red dip, and set sides in sturdy bowls."], notes: "Lexington-style plates lean into pork shoulder, red vinegar dip, slaw, beans, and dessert." }
  ],
  "virginia-soul-food": [
    { id: "tidewater-table", title: "Virginia Tidewater Table", recipeIds: ["virginia-country-ham", "virginia-brunswick-stew", "southern-collard-greens", "buttermilk-biscuits", "sweet-tea", "peach-cobbler"], timeline: ["Morning: start stew and prep greens.", "One hour before: warm ham and bake biscuits.", "Serve: keep stew hot and biscuits covered."], notes: "Virginia should feel steady: ham biscuits, thick stew, greens, tea, and a dessert that travels." },
    { id: "historic-comfort", title: "Virginia Comfort Supper", recipeIds: ["virginia-peanut-soup", "smothered-pork-chops", "southern-collard-greens", "cornbread", "buttermilk-biscuits", "sweet-tea"], timeline: ["Morning: prep soup base and wash greens.", "Two hours before: start greens and season pork chops.", "Serve: simmer soup gently, finish gravy, and bring bread hot."], notes: "Peanut soup, gravy, greens, and bread give this table its Virginia identity." }
  ]
};
