...
const menuPairings = [
  ...
  },
  {
    ...
    alternate_recipe_ids: ["bbq-smoked-ribs", "fried-chicken", "bbq-pulled-pork", "banana-pudding"],
    traditional_sides: ["baked beans", "collard greens", "cornbread", "potato salad", "coleslaw"],
    breads: ["cornbread", "dinner rolls"],
    sauces_condiments: ["barbecue sauce", "hot sauce", "pickles", "lemon"],
    drinks: ["strawberry soda", "red punch", "lemonade", "ice water"],
    desserts: ["red velvet cake", "watermelon", "peach cobbler"],
    cultural_notes: "A Juneteenth table should feel like freedom, family, music, memory, and a backyard full of people being fed with care.",
    beginner_level: "Choose one smoked or grilled main, two make-ahead sides, one bread, one red drink, and one dessert.",
    pro_level: "Start smoked meats early, chill drinks before guests arrive, hold hot sides safely, and set up a serving line that keeps people moving.",
    cook_time: "2-12 hours",
    hosting_notes: "Use card tables, labeled pans, coolers of drinks, shade, trash bags, and a simple timeline so the host can actually enjoy the gathering."
  },
  {
    cuisine: "Cajun",
...
const regionalAuthenticityRecipes = [
  ...
  ["mississippi-perch-fry", "Mississippi Fried Perch", "mississippi-favorites", "Seafood", "assets/lc-seafood.jpg", "15 min", "15 min", "Beginner", 4, "Small perch fillets fried in seasoned cornmeal for a crisp Mississippi fish-fry plate.", ["1 1/2 lb perch fillets", "1 cup buttermilk", "1 tsp hot sauce", "1 cup yellow cornmeal", "1/3 cup flour", "1 tsp seasoned salt", "1/2 tsp lemon pepper", "Oil for frying"], ["Pat perch dry and season lightly.", "Dip in buttermilk and hot sauce.", "Dredge in cornmeal, flour, seasoned salt, and lemon pepper.", "Fry at 350 F until crisp and flaky, 3 to 4 minutes per side.", "Drain on a rack and serve with comeback sauce."], ["mississippi", "perch", "fish fry", "cornmeal", "seafood"]],
  ["mississippi-bream-fry", "Mississippi Fried Bream", "mississippi-favorites", "Seafood", "assets/lc-seafood.jpg", "15 min", "15 min", "Beginner", 4, "Cornmeal-fried bream with hot sauce, lemon, and the kind of crisp edges people reach for first.", ["1 1/2 lb cleaned bream", "1 cup buttermilk", "1 cup cornmeal", "1/2 cup flour", "1 tsp paprika", "1 tsp seasoned salt", "Oil for frying", "Lemon wedges"], ["Score whole bream lightly if using whole fish.", "Soak in buttermilk 10 minutes.", "Mix cornmeal, flour, paprika, and seasoned salt.", "Coat fish well and shake off extra.", "Fry until golden and cooked through; serve hot."], ["mississippi", "bream", "fish fry", "whole fish", "soul food"]],
  ["mississippi-crappie-fry", "Mississippi Fried Crappie", "mississippi-favorites", "Seafood", "assets/lc-seafood.jpg", "15 min", "12 min", "Beginner", 4, "Tender crappie fillets fried light and crisp for lake-day and family-fry plates.", ["1 1/2 lb crappie fillets", "1 egg", "1/2 cup milk", "1 cup cornmeal", "1/2 cup flour", "1 tsp Cajun seasoning", "Oil for frying"], ["Whisk egg and milk.", "Mix cornmeal, flour, and Cajun seasoning.", "Dip crappie in egg wash, then cornmeal.", "Fry at 350 F until golden and flaky.", "Drain and season while hot."], ["mississippi", "crappie", "fish fry", "lake fish", "seafood"]],
  ["mississippi-fish-fry-plate", "Mississippi Fish Fry Plate", "mississippi-favorites", "Platters", "assets/lc-seafood.jpg", "30 min", "35 min", "Intermediate", 8, "A full Mississippi fish fry plate with fried fish, slaw, potato salad, hot sauce, bread, and cold tea.", ["2 lb catfish or buffalo fish", "1 cup buttermilk", "1 1/2 cups cornmeal", "1/2 cup flour", "2 tsp seasoned salt", "4 cups coleslaw", "4 cups potato salad", "Hot sauce", "Lemon", "White bread"], ["Prep cold sides first and keep chilled.", "Soak fish in buttermilk and hot sauce.", "Dredge fish in seasoned cornmeal.", "Fry in batches until crisp.", "Serve with slaw, potato salad, bread, lemon, hot sauce, and tea."], ["mississippi", "fish fry plate", "catfish", "buffalo fish", "family reunion"]],
  ["comeback-sauce", "Mississippi Comeback Sauce", "mississippi-favorites", "Sauces", "assets/editorial-kitchen-prep.jpg", "10 min", "0 min", "Beginner", 12, "A creamy, tangy Mississippi sauce for fried fish, fries, burgers, and po'boy-style sandwiches.", ["1 cup mayonnaise", "1/4 cup chili sauce", "2 tbsp ketchup", "1 tbsp lemon juice", "1 tbsp Worcestershire sauce", "1 tsp hot sauce", "1 tsp garlic powder", "1/2 tsp paprika", "Black pepper"], ["Whisk mayonnaise, chili sauce, ketchup, lemon, Worcestershire, and hot sauce.", "Add garlic powder, paprika, and black pepper.", "Taste for heat and acidity.", "Chill at least 20 minutes.", "Serve with fried fish, fries, or sandwiches."], ["mississippi", "comeback sauce", "sauce", "fish fry", "dipping sauce"]],
  ...
  ["oyster-poboy", "Louisiana Oyster Po'Boy", "louisiana", "Sandwiches", "images/regional/shrimp-poboy.png", "25 min", "12 min", "Intermediate", 4, "Cornmeal-fried oysters packed into French bread with lettuce, tomato, pickles, and remoulade.", ["1 pint shucked oysters", "1 cup buttermilk", "1 cup cornmeal", "1/2 cup flour", "2 tsp Creole seasoning", "4 French bread rolls", "Lettuce", "Tomato", "Pickles", "Remoulade", "Oil for frying"], ["Drain oysters and pat gently.", "Dip in buttermilk.", "Dredge in cornmeal, flour, and Creole seasoning.", "Fry at 350 F until crisp, about 2 minutes.", "Build po'boys with bread, sauce, lettuce, tomato, pickles, and oysters."], ["louisiana", "oyster po boy", "seafood", "new orleans"]],
  ...
  ["charbroiled-oysters", "New Orleans Charbroiled Oysters", "louisiana", "Seafood", "assets/lc-seafood.jpg", "20 min", "8 min", "Intermediate", 4, "Oysters grilled with garlic butter, herbs, hot sauce, and Parmesan until bubbling.", ["24 oysters on the half shell", "1 stick butter", "4 garlic cloves minced", "1 tbsp lemon juice", "1 tsp hot sauce", "1/2 cup Parmesan", "2 tbsp parsley", "French bread"], ["Heat grill to high.", "Melt butter with garlic, lemon, and hot sauce.", "Place oysters on grill and spoon butter over each.", "Sprinkle with Parmesan and cook until bubbling.", "Finish with parsley and serve with bread."], ["louisiana", "charbroiled oysters", "new orleans", "seafood"]],
  ...
  ["crawfish-boil", "Louisiana Crawfish Boil", "louisiana", "Seafood", "assets/lc-seafood.jpg", "30 min", "45 min", "Intermediate", 10, "A backyard crawfish boil with potatoes, corn, sausage, citrus, garlic, and plenty of seasoning.", ["10 lb live crawfish purged", "1/2 cup seafood boil seasoning", "2 lb small potatoes", "2 lb smoked sausage", "8 ears corn", "2 lemons halved", "2 heads garlic", "1 stick butter"], ["Bring a large pot of seasoned water, lemons, and garlic to a boil.", "Add potatoes and cook until almost tender.", "Add sausage and corn.", "Add crawfish and cook just until shells turn bright.", "Turn off heat, soak briefly for flavor, drain, and serve table-style."], ["louisiana", "crawfish boil", "seafood", "backyard", "hosting"]],
  ...
  ["texas-smoked-sausage", "Texas Smoked Sausage Links", "texas", "BBQ", "images/regional/texas-beef-ribs.png", "10 min", "1 hr 30 min", "Beginner", 8, "Smoked sausage links warmed low and slow, sliced for barbecue plates with beans, bread, pickles, and sauce.", ["2 lb smoked beef or pork sausage links", "1 tbsp neutral oil", "1/2 cup barbecue sauce optional", "Pickles", "White bread", "Sliced onion"], ["Heat smoker or grill to 250 F with indirect heat.", "Rub sausage lightly with oil so the casings do not dry out.", "Smoke until hot through and lightly crisped, 60 to 90 minutes.", "Brush with sauce during the last 10 minutes if desired.", "Rest 5 minutes, slice, and serve with pickles, bread, and onion."], ["texas", "bbq", "sausage", "smoked", "cookout"]],
  ["jalapeno-cheddar-sausage", "Texas Jalapeno Cheddar Sausage", "texas", "BBQ", "images/regional/texas-beef-ribs.png", "10 min", "1 hr", "Beginner", 8, "Smoked jalapeno cheddar sausage links for a Texas barbecue tray with brisket, ribs, beans, and pickles.", ["2 lb jalapeno cheddar sausage links", "1 tbsp neutral oil", "Pickles", "White bread", "Sliced onion", "Barbecue sauce optional"], ["Heat smoker or grill to 250 F.", "Oil sausage lightly to protect the casing.", "Smoke or warm over indirect heat until hot through.", "Rest 5 minutes.", "Slice on a bias and serve with pickles, onion, bread, and sauce."], ["texas", "jalapeno cheddar sausage", "bbq", "smoked sausage"]],
  ...
  ["alabama-pulled-pork-sandwiches", "Alabama Pulled Pork Sandwiches", "alabama", "BBQ", "images/juneteenth/pulled-pork-shoulder.png", "25 min", "5 hr", "Advanced", 10, "Slow-cooked pork shoulder piled on buns with slaw and tangy sauce for an Alabama barbecue plate.", ["4 lb pork shoulder", "2 tbsp brown sugar", "1 tbsp paprika", "1 tbsp kosher salt", "2 tsp black pepper", "1 tsp garlic powder", "1 cup apple cider vinegar", "1 cup chicken stock", "10 buns", "2 cups coleslaw"], ["Mix sugar, paprika, salt, pepper, and garlic powder.", "Rub pork shoulder all over and rest 30 minutes.", "Cook covered at 300 F with vinegar and stock until shreddable, 4 to 5 hours.", "Rest 20 minutes, then shred with pan juices.", "Pile onto buns with coleslaw and sauce."], ["alabama", "pulled pork", "bbq", "sandwiches", "church supper"]],
  ["alabama-fried-green-tomatoes", "Alabama Fried Green Tomatoes", "alabama", "Sides", "images/cuisines/southern/southern-01.png", "15 min", "15 min", "Beginner", 6, "Firm green tomatoes coated in cornmeal and fried crisp for a tart Southern side or starter.", ["3 green tomatoes sliced", "1 cup buttermilk", "1 egg", "3/4 cup cornmeal", "1/2 cup flour", "1 tsp seasoned salt", "1/2 tsp black pepper", "Oil for frying"], ["Slice tomatoes 1/3 inch thick and pat dry.", "Whisk buttermilk and egg.", "Mix cornmeal, flour, seasoned salt, and pepper.", "Dip tomatoes in buttermilk, then dredge in cornmeal mix.", "Fry at 350 F until golden on both sides and drain on a rack."], ["alabama", "fried green tomatoes", "cornmeal", "side dish"]],
  ["nashville-hot-chicken", "Nashville Hot Chicken", "tennessee", "Main Dishes", "images/cuisines/southern/southern-01.png", "25 min", "35 min", "Advanced", 6, "Crispy fried chicken brushed with spicy cayenne oil and served with pickles and bread.", ["6 chicken pieces", "2 cups buttermilk", "2 tbsp hot sauce", "2 cups flour", "1 tbsp seasoned salt", "1 tbsp paprika", "2 tsp cayenne plus more to taste", "1 cup frying oil for hot oil", "Pickles", "White bread"], ["Marinate chicken in buttermilk and hot sauce for at least 2 hours.", "Dredge in seasoned flour and rest 10 minutes.", "Fry at 325 to 350 F until the thickest pieces reach 165 F.", "Whisk some hot frying oil with cayenne, paprika, and a pinch of sugar.", "Brush hot oil over chicken and serve with pickles and bread."], ["tennessee", "nashville", "hot chicken", "fried chicken", "music night"]],
  ["memphis-dry-rub-ribs", "Memphis Dry-Rub Ribs", "tennessee", "BBQ", "images/regional/texas-beef-ribs.png", "20 min", "4 hr", "Advanced", 6, "Pork ribs seasoned with a Memphis-style dry rub, smoked until tender, and served with sauce on the side.", ["2 racks pork ribs", "2 tbsp brown sugar", "1 tbsp paprika", "1 tbsp black pepper", "1 tbsp kosher salt", "2 tsp garlic powder", "2 tsp onion powder", "1 tsp cayenne", "1/2 cup apple juice"], ["Remove membrane from ribs.", "Mix spices into a dry rub and coat ribs generously.", "Smoke or bake covered at 250 F until tender, about 3 hours.", "Spritz lightly with apple juice if dry.", "Uncover to set the bark, rest, and slice."], ["tennessee", "memphis", "ribs", "dry rub", "bbq"]],
  ["memphis-bbq-spaghetti", "Memphis BBQ Spaghetti", "tennessee", "Sides", "assets/lc-pasta.jpg", "15 min", "35 min", "Beginner", 6, "Spaghetti tossed with smoky barbecue sauce, tomato, onion, and chopped pulled pork for a Memphis-style side.", ["12 oz spaghetti", "1 cup chopped pulled pork", "1 cup tomato sauce", "3/4 cup barbecue sauce", "1/2 onion diced", "1 bell pepper diced", "1 tbsp oil", "1 tsp garlic powder"], ["Boil spaghetti until just tender.", "Cook onion and bell pepper in oil.", "Add tomato sauce, barbecue sauce, garlic powder, and pulled pork.", "Simmer until smoky and thickened.", "Toss with spaghetti and serve warm."], ["tennessee", "memphis", "bbq spaghetti", "pulled pork", "side dish"]],
  ["arkansas-fried-pickles", "Arkansas Fried Pickles", "arkansas", "Sides", "images/cuisines/southern/southern-01.png", "15 min", "10 min", "Beginner", 6, "Dill pickle chips coated in seasoned cornmeal batter and fried crisp for a Delta-style snack plate.", ["2 cups dill pickle chips", "1 cup buttermilk", "1 egg", "3/4 cup cornmeal", "1/2 cup flour", "1 tsp Cajun seasoning", "Oil for frying", "Ranch or comeback sauce"], ["Drain pickles well and pat dry.", "Whisk buttermilk and egg.", "Mix cornmeal, flour, and seasoning.", "Dip pickles in wet mix, then dredge in cornmeal.", "Fry at 350 F until crisp and serve with sauce."], ["arkansas", "fried pickles", "delta", "snack", "fish fry"]],
  ["arkansas-delta-tamales", "Arkansas Delta Hot Tamales", "arkansas", "Main Dishes", "assets/lc-birria-tacos.jpg", "45 min", "2 hr", "Advanced", 12, "Delta-style tamales with seasoned meat wrapped in cornmeal masa and simmered until tender.", ["2 lb ground beef or shredded beef", "2 cups masa harina", "1 cup cornmeal", "3 tbsp chili powder", "2 tsp cumin", "2 tsp salt", "3 cups beef broth", "Corn husks", "Hot sauce"], ["Soak corn husks until pliable.", "Season and cook beef with chili powder, cumin, salt, and a little broth.", "Mix masa, cornmeal, and broth into a spreadable dough.", "Spread dough on husks, add meat, and roll tightly.", "Simmer tamales in seasoned broth until firm and tender."], ["arkansas", "delta", "hot tamales", "cornmeal", "family gathering"]],
  ["arkansas-chocolate-gravy-biscuits", "Chocolate Gravy and Biscuits", "arkansas", "Breakfast", "images/cuisines/southern/southern-05.png", "10 min", "12 min", "Beginner", 6, "A Southern breakfast treat with cocoa gravy spooned over warm biscuits.", ["1/3 cup cocoa powder", "3/4 cup sugar", "3 tbsp flour", "2 cups milk", "2 tbsp butter", "1 tsp vanilla", "6 warm biscuits"], ["Whisk cocoa, sugar, and flour in a saucepan.", "Slowly whisk in milk until smooth.", "Cook over medium heat, stirring, until thickened.", "Remove from heat and stir in butter and vanilla.", "Spoon warm gravy over split biscuits."], ["arkansas", "chocolate gravy", "biscuits", "breakfast", "comfort food"]],
  ...
  ["eastern-nc-bbq", "Eastern North Carolina Chopped BBQ", "north-carolina", "BBQ", "images/juneteenth/pulled-pork-shoulder.png", "25 min", "6 hr", "Advanced", 10, "Whole-hog inspired chopped pork dressed with a sharp vinegar-pepper sauce for an Eastern North Carolina plate.", ["5 lb pork shoulder", "2 tbsp kosher salt", "2 tbsp black pepper", "1 tbsp paprika", "1 cup apple cider vinegar", "1 tbsp brown sugar", "1 tbsp red pepper flakes", "1 tsp hot sauce", "Buns or cornbread for serving"], ["Season pork with salt, pepper, and paprika.", "Smoke or roast at 275 F until pull-apart tender, about 5 to 6 hours.", "Whisk vinegar, brown sugar, red pepper flakes, and hot sauce.", "Rest pork 30 minutes, then chop finely.", "Toss with vinegar sauce a little at a time so the meat stays bright, not wet.", "Serve with slaw, cornbread, or buns."], ["north carolina", "eastern nc bbq", "vinegar sauce", "whole hog", "pulled pork"]],
  ["lexington-bbq", "Lexington-Style Pork Shoulder BBQ", "north-carolina", "BBQ", "images/juneteenth/pulled-pork-shoulder.png", "25 min", "5 hr", "Advanced", 10, "Piedmont-style pork shoulder served with a tangy red vinegar dip and slaw.", ["5 lb pork shoulder", "2 tbsp kosher salt", "2 tbsp black pepper", "1 tbsp paprika", "1 cup apple cider vinegar", "1/3 cup ketchup", "1 tbsp brown sugar", "1 tsp crushed red pepper", "Lexington slaw for serving"], ["Season pork and smoke or roast at 275 F until tender.", "Whisk vinegar, ketchup, brown sugar, and red pepper into a thin dip.", "Rest pork, then chop or pull.", "Moisten pork with dip and keep extra on the side.", "Serve with slaw and hushpuppy-style bread or cornbread."], ["north carolina", "lexington bbq", "piedmont", "pork shoulder", "red dip"]],
  ["virginia-country-ham", "Virginia Country Ham Biscuits", "virginia", "Breakfast", "images/cuisines/southern/southern-05.png", "15 min", "10 min", "Beginner", 8, "Salty Virginia country ham tucked into warm biscuits with a little butter or preserves.", ["16 small biscuits", "1 lb thin-sliced country ham", "2 tbsp butter", "Apple butter or pepper jelly optional"], ["Warm biscuits and split gently.", "Heat a skillet over medium and warm ham slices just until edges curl.", "Butter biscuits lightly.", "Tuck ham inside each biscuit.", "Serve plain or with apple butter or pepper jelly."], ["virginia", "country ham", "ham biscuits", "breakfast", "church supper"]],
  ["virginia-brunswick-stew", "Virginia Brunswick Stew", "virginia", "Stews", "assets/american-food.jpeg", "25 min", "1 hr 30 min", "Intermediate", 8, "A thick Virginia-style stew with chicken, vegetables, tomato, corn, lima beans, and gentle smoke.", ["2 lb cooked shredded chicken", "1 onion diced", "2 cups crushed tomatoes", "3 cups chicken stock", "2 cups corn", "2 cups lima beans", "2 potatoes diced", "1 tbsp Worcestershire sauce", "1 tsp smoked paprika", "Salt and pepper"], ["Cook onion in a heavy pot until soft.", "Add tomatoes, stock, potatoes, Worcestershire, paprika, salt, and pepper.", "Simmer until potatoes are tender.", "Stir in chicken, corn, and lima beans.", "Cook until thick and spoonable.", "Taste and adjust seasoning before serving."], ["virginia", "brunswick stew", "chicken stew", "vegetables", "community supper"]],
  ["virginia-peanut-soup", "Virginia Peanut Soup", "virginia", "Soups", "assets/ingredients.jpeg", "15 min", "30 min", "Beginner", 6, "A smooth Virginia peanut soup with onion, stock, cream, and roasted peanut flavor.", ["2 tbsp butter", "1 onion diced", "2 tbsp flour", "4 cups chicken or vegetable stock", "1 cup smooth peanut butter", "1/2 cup cream", "1 tsp lemon juice", "Salt and cayenne to taste", "Chopped peanuts for garnish"], ["Cook onion in butter until soft.", "Stir in flour and cook 1 minute.", "Whisk in stock gradually until smooth.", "Whisk in peanut butter and simmer gently.", "Stir in cream and lemon juice.", "Season with salt and cayenne, then garnish with peanuts."], ["virginia", "peanut soup", "soup", "historic", "comfort food"]],
  ...
  ["florida-blue-crab", "Florida Blue Crab Boil", "florida", "Seafood", "images/regional/stone-crab.png", "20 min", "25 min", "Beginner", 4, "Blue crabs steamed or boiled with citrus, seasoning, and butter for a coastal Florida table.", ["2 dozen blue crabs", "1/4 cup seafood seasoning", "2 lemons halved", "2 bay leaves", "1 stick butter", "Hot sauce"], ["Bring a large pot of water with seasoning, lemons, and bay to a boil.", "Add crabs carefully and cover.", "Cook until shells are bright and meat is cooked, about 12 to 15 minutes.", "Drain and serve with melted butter, lemon, and hot sauce."], ["florida", "blue crab", "seafood", "coastal"]],
  ["grouper-sandwich", "Florida Grouper Sandwich", "florida", "Sandwiches", "assets/lc-seafood.jpg", "20 min", "12 min", "Beginner", 4, "Golden grouper on a soft bun with lettuce, tomato, tartar sauce, and lemon.", ["4 grouper fillets", "1 cup flour", "1 egg", "1 cup breadcrumbs or cornmeal", "4 buns", "Lettuce", "Tomato", "Tartar sauce", "Lemon"], ["Season grouper lightly.", "Dredge in flour, egg, then crumbs or cornmeal.", "Pan-fry until golden and flaky.", "Toast buns.", "Build sandwiches with lettuce, tomato, tartar sauce, and lemon."], ["florida", "grouper sandwich", "seafood", "coastal"]],
  ["smoked-mullet", "Florida Smoked Mullet", "florida", "Seafood", "assets/lc-seafood.jpg", "15 min", "2 hr", "Intermediate", 4, "Florida-style smoked mullet served with lemon, crackers, hot sauce, or made into fish dip.", ["2 lb cleaned mullet", "2 tbsp kosher salt", "1 tbsp brown sugar", "1 tsp black pepper", "Lemon wedges", "Crackers", "Hot sauce"], ["Pat mullet dry.", "Season with salt, sugar, and pepper.", "Refrigerate 30 minutes, then pat dry again.", "Smoke at 200 to 225 F until firm and flaky.", "Serve warm or chilled with lemon, crackers, and hot sauce."], ["florida", "smoked mullet", "seafood", "fish dip"]],
  ...
  ["white-perch-fry", "Mississippi White Perch Fry", "mississippi-favorites", "Seafood", "assets/logo.png", "15 min", "12 min", "Beginner", 4, "Delicate white perch fillets fried in seasoned cornmeal for a Mississippi lake fish plate.", ["1 1/2 lb white perch fillets", "1 cup buttermilk", "1 tsp hot sauce", "1 cup yellow cornmeal", "1/3 cup flour", "1 tsp seasoned salt", "1/2 tsp lemon pepper", "Oil for frying"], ["Pat fish dry and check for small bones.", "Soak in buttermilk and hot sauce for 10 minutes.", "Mix cornmeal, flour, seasoned salt, and lemon pepper.", "Dredge fish and fry at 350 F until golden and flaky.", "Drain on a rack and serve with comeback sauce."], ["mississippi", "white perch", "fish fry", "lake fish"]],
  ["chicken-and-dumplings", "Southern Chicken and Dumplings", "mississippi-favorites", "Main Dishes", "assets/logo.png", "25 min", "1 hr 10 min", "Intermediate", 6, "Tender chicken simmered with soft dumplings in a peppery broth for a Sunday table.", ["3 lb bone-in chicken pieces", "8 cups chicken stock", "1 onion diced", "2 celery stalks diced", "2 carrots diced", "2 cups flour", "1 tbsp baking powder", "3/4 cup buttermilk", "3 tbsp butter", "Salt and black pepper"], ["Simmer chicken with stock and vegetables until tender.", "Remove chicken, shred meat, and return it to the pot.", "Mix flour, baking powder, butter, buttermilk, salt, and pepper into a soft dough.", "Drop spoonfuls of dough into simmering broth.", "Cover and simmer until dumplings are fluffy and cooked through.", "Adjust salt and black pepper before serving."], ["mississippi", "chicken and dumplings", "sunday dinner", "comfort food"]],
  ["mississippi-butter-beans", "Mississippi Butter Beans", "mississippi-favorites", "Sides", "assets/logo.png", "15 min", "1 hr 20 min", "Beginner", 6, "Creamy butter beans simmered with onion, garlic, and smoked turkey until tender.", ["1 lb dried lima or butter beans soaked", "1 smoked turkey wing", "1 onion diced", "3 garlic cloves", "6 cups chicken stock", "1 bay leaf", "1 tbsp butter", "Salt and pepper"], ["Rinse soaked beans.", "Simmer beans with smoked turkey, onion, garlic, stock, and bay leaf.", "Cook until creamy and tender.", "Remove meat from the turkey wing and return it to the pot.", "Finish with butter, salt, and pepper."], ["mississippi", "butter beans", "sides", "sunday dinner"]],
  ["turnip-greens", "Turnip Greens with Pot Liquor", "mississippi-favorites", "Sides", "assets/logo.png", "25 min", "1 hr 15 min", "Beginner", 6, "Turnip greens simmered with smoked meat, onion, vinegar, and pepper sauce until tender.", ["2 bunches turnip greens washed and chopped", "1 smoked turkey wing or ham hock", "1 onion sliced", "4 cups chicken stock", "1 tbsp apple cider vinegar", "1 tsp sugar optional", "Hot sauce", "Salt and pepper"], ["Wash greens well until no grit remains.", "Simmer smoked meat, onion, and stock for 30 minutes.", "Add greens by handfuls and cook until tender.", "Season with vinegar, sugar if needed, salt, pepper, and hot sauce.", "Serve with cornbread for the pot liquor."], ["mississippi", "turnip greens", "greens", "pot liquor"]],
  ["red-beans-and-rice", "Louisiana Red Beans and Rice", "louisiana", "Main Dishes", "assets/logo.png", "20 min", "2 hr", "Beginner", 6, "Creamy red beans simmered with smoked sausage, trinity, spices, and rice for a Monday-style Louisiana supper.", ["1 lb dried red beans soaked", "1 lb smoked sausage sliced", "1 onion diced", "1 bell pepper diced", "2 celery stalks diced", "4 garlic cloves", "2 bay leaves", "1 tsp thyme", "6 cups stock", "4 cups cooked white rice"], ["Brown sausage and set aside.", "Cook onion, bell pepper, celery, and garlic.", "Add beans, bay, thyme, stock, and sausage.", "Simmer until beans are creamy, mashing some against the pot.", "Season to taste and serve over rice."], ["louisiana", "red beans and rice", "creole", "rice"]],
  ["louisiana-boudin", "Louisiana Boudin Links", "louisiana", "Main Dishes", "assets/logo.png", "20 min", "25 min", "Intermediate", 6, "Seasoned pork, liver, rice, green onion, and Cajun spices shaped into links or patties.", ["1 lb cooked pork shoulder minced", "1/2 lb cooked pork liver minced optional", "3 cups cooked rice", "1 onion minced", "1 bell pepper minced", "2 celery stalks minced", "3 green onions sliced", "2 tsp Cajun seasoning", "Sausage casings optional"], ["Cook trinity until soft.", "Mix pork, liver if using, rice, trinity, green onion, and seasoning.", "Taste and adjust spice.", "Stuff into casings or shape into patties.", "Steam links or pan-sear patties until hot through."], ["louisiana", "boudin", "cajun", "rice"]],
  ["fried-oysters", "Louisiana Fried Oysters", "louisiana", "Seafood", "assets/logo.png", "15 min", "8 min", "Intermediate", 4, "Briny oysters dredged in cornmeal and fried crisp for po'boys or platters.", ["1 pint shucked oysters", "1 cup buttermilk", "1 cup cornmeal", "1/2 cup flour", "2 tsp Creole seasoning", "Oil for frying", "Lemon wedges", "Remoulade"], ["Drain oysters and pat gently.", "Dip in buttermilk.", "Dredge in cornmeal, flour, and Creole seasoning.", "Fry at 350 F until crisp and just cooked.", "Serve with lemon and remoulade."], ["louisiana", "fried oysters", "seafood", "new orleans"]],
  ["chicken-fried-steak", "Texas Chicken Fried Steak", "texas", "Main Dishes", "assets/logo.png", "20 min", "25 min", "Intermediate", 4, "Tenderized beef cutlets fried crisp and served with peppered cream gravy.", ["4 cube steaks", "1 1/2 cups flour", "2 tsp seasoned salt", "1 tsp black pepper", "1 egg", "1 cup buttermilk", "Oil for frying", "2 cups milk for gravy"], ["Season flour with salt and pepper.", "Dip steaks in buttermilk and egg, then dredge in flour.", "Fry until golden and cooked through.", "Pour off most oil, leaving drippings.", "Whisk flour into drippings, then milk, and simmer into pepper gravy.", "Serve gravy over steak."], ["texas", "chicken fried steak", "cream gravy", "comfort food"]],
  ["texas-kolaches", "Texas Sausage Kolaches", "texas", "Breakfast", "assets/logo.png", "25 min", "20 min", "Intermediate", 8, "Soft Texas bakery-style dough wrapped around smoked sausage and cheese.", ["8 smoked sausage links", "8 slices cheddar", "3 cups flour", "2 1/4 tsp yeast", "1 cup warm milk", "1/4 cup sugar", "1 egg", "4 tbsp butter", "1 tsp salt"], ["Make a soft yeast dough with milk, sugar, yeast, egg, butter, flour, and salt.", "Let rise until doubled.", "Wrap dough around sausage and cheese.", "Proof 20 minutes.", "Bake at 375 F until golden."], ["texas", "kolaches", "breakfast", "sausage"]],
  ["texas-pinto-beans", "Texas Pinto Beans", "texas", "Sides", "assets/logo.png", "15 min", "2 hr", "Beginner", 8, "Pinto beans simmered with onion, garlic, chile, and smoked meat for a barbecue plate.", ["1 lb dried pinto beans soaked", "1 onion diced", "3 garlic cloves", "1 jalapeno split", "1 smoked ham hock or bacon", "6 cups stock", "1 tsp cumin", "Salt and pepper"], ["Simmer soaked beans with onion, garlic, jalapeno, smoked meat, stock, and cumin.", "Cook until tender and creamy.", "Remove smoked meat, chop, and return to pot.", "Season with salt and pepper."], ["texas", "pinto beans", "bbq side", "beans"]],
  ["conch-fritters", "Florida Conch Fritters", "florida", "Seafood", "assets/logo.png", "20 min", "15 min", "Intermediate", 6, "Chopped conch folded into seasoned batter and fried into crisp coastal fritters.", ["1 lb chopped conch", "1 cup flour", "1 tsp baking powder", "1 egg", "1/2 cup milk", "1/2 onion minced", "1 bell pepper minced", "1 tsp Old Bay or seafood seasoning", "Oil for frying"], ["Mix flour, baking powder, egg, milk, onion, pepper, seasoning, and conch.", "Rest batter 10 minutes.", "Drop spoonfuls into 350 F oil.", "Fry until golden and cooked through.", "Serve with citrusy dipping sauce."], ["florida", "conch", "fritters", "coastal"]],
  ["datil-pepper-sauce", "Florida Datil Pepper Sauce", "florida", "Sauces", "assets/logo.png", "10 min", "20 min", "Beginner", 12, "A sweet-hot St. Augustine-style datil pepper sauce for seafood, chicken, and sandwiches.", ["1 cup chopped datil peppers or habaneros", "1 cup vinegar", "1/2 cup ketchup", "1/2 cup honey", "2 garlic cloves", "1 tsp salt"], ["Simmer peppers, vinegar, ketchup, honey, garlic, and salt until softened.", "Blend carefully until smooth.", "Simmer 5 minutes more.", "Cool and refrigerate."], ["florida", "datil pepper", "sauce", "st augustine"]],
  ["tennessee-chess-pie", "Tennessee Chess Pie", "tennessee", "Desserts", "assets/logo.png", "15 min", "45 min", "Beginner", 8, "A simple custardy Southern pie with sugar, butter, eggs, cornmeal, and vanilla.", ["1 unbaked pie crust", "1 1/2 cups sugar", "1 tbsp cornmeal", "1 tbsp flour", "4 eggs", "1/2 cup melted butter", "1/4 cup milk", "1 tbsp vinegar", "1 tsp vanilla"], ["Whisk sugar, cornmeal, and flour.", "Whisk in eggs, butter, milk, vinegar, and vanilla.", "Pour into crust.", "Bake at 350 F until set with a slight wobble.", "Cool completely before slicing."], ["tennessee", "chess pie", "dessert", "southern"]],
  ["virginia-spoon-bread", "Virginia Spoon Bread", "virginia", "Sides", "assets/logo.png", "15 min", "35 min", "Beginner", 6, "A soft cornmeal spoon bread baked until puffed and tender.", ["1 cup cornmeal", "2 cups milk", "3 eggs separated", "2 tbsp butter", "1 tsp salt", "1 tsp baking powder"], ["Cook cornmeal and milk until thick.", "Stir in butter, salt, and baking powder.", "Beat in egg yolks.", "Fold in whipped egg whites.", "Bake at 375 F until puffed and golden."], ["virginia", "spoon bread", "cornmeal", "side"]],
  ["carolina-vinegar-sauce", "Carolina Vinegar BBQ Sauce", "north-carolina", "Sauces", "assets/logo.png", "5 min", "5 min", "Beginner", 16, "A sharp vinegar-pepper sauce for chopped pork and pulled barbecue.", ["1 cup apple cider vinegar", "1 tbsp brown sugar", "1 tbsp red pepper flakes", "1 tsp hot sauce", "1 tsp salt", "1/2 tsp black pepper"], ["Warm vinegar just enough to dissolve sugar and salt.", "Stir in pepper flakes, hot sauce, and black pepper.", "Cool and let steep 30 minutes.", "Spoon over chopped pork, not as a thick glaze."], ["north carolina", "vinegar sauce", "bbq", "sauce"]],
  ["carolina-hush-puppies", "Carolina Hush Puppies", "north-carolina", "Breads", "assets/logo.png", "15 min", "12 min", "Beginner", 6, "Crisp cornmeal hush puppies served with fish camp plates and barbecue.", ["1 1/2 cups cornmeal", "1/2 cup flour", "1 tbsp sugar", "1 tsp baking powder", "1/2 tsp salt", "1 egg", "1 cup buttermilk", "1/4 cup minced onion", "Oil for frying"], ["Mix dry ingredients.", "Stir in egg, buttermilk, and onion.", "Rest batter 10 minutes.", "Drop spoonfuls into 350 F oil.", "Fry until golden and drain well."], ["north carolina", "hush puppies", "fish camp", "cornmeal"]],
  ["carolina-red-rice", "South Carolina Red Rice", "low-country", "Sides", "assets/logo.png", "15 min", "40 min", "Beginner", 6, "Tomato-rich rice cooked with onion, bell pepper, and smoky seasoning for a Lowcountry table.", ["1 1/2 cups long-grain rice", "1 onion diced", "1 bell pepper diced", "2 cups crushed tomatoes", "1 1/2 cups stock", "4 slices bacon chopped optional", "1 tsp smoked paprika", "Salt and pepper"], ["Cook bacon if using, then saute onion and bell pepper.", "Stir in rice, tomatoes, stock, paprika, salt, and pepper.", "Cover and simmer until rice is tender.", "Rest 10 minutes before fluffing."], ["south carolina", "red rice", "lowcountry", "rice"]],
  ["gullah-geechee-favorites", "Gullah Geechee Heritage Plate", "low-country", "Platters", "assets/logo.png", "35 min", "1 hr", "Intermediate", 6, "A learning plate connecting rice, okra, seafood, greens, and field peas to Gullah Geechee foodways.", ["3 cups cooked red rice", "2 cups okra tomato stew", "1 lb sauteed shrimp", "4 cups cooked greens", "2 cups field peas", "Lemon", "Hot sauce"], ["Prepare red rice and keep warm.", "Simmer okra and tomatoes until tender.", "Season and saute shrimp quickly.", "Warm greens and field peas.", "Serve as a composed plate with lemon and hot sauce."], ["south carolina", "gullah geechee", "heritage", "lowcountry"]],
  ["vidalia-onion-pie", "Georgia Vidalia Onion Pie", "georgia", "Sides", "assets/logo.png", "20 min", "40 min", "Beginner", 8, "Sweet Vidalia onions baked into a savory custard pie for church suppers and spring tables.", ["1 pie crust", "3 cups sliced Vidalia onions", "2 tbsp butter", "3 eggs", "1 cup milk", "1 cup shredded cheddar", "1/2 tsp salt", "1/2 tsp pepper"], ["Cook onions in butter until soft and sweet.", "Whisk eggs, milk, cheese, salt, and pepper.", "Spread onions in crust.", "Pour custard over onions.", "Bake at 350 F until set and lightly golden."], ["georgia", "vidalia onion", "pie", "side dish"]],
  ["georgia-brunswick-stew", "Georgia Brunswick Stew", "georgia", "Stews", "assets/logo.png", "25 min", "1 hr 20 min", "Intermediate", 8, "A thick Georgia-style stew with chicken, pork, tomatoes, corn, lima beans, and barbecue notes.", ["2 cups shredded chicken", "2 cups pulled pork", "1 onion diced", "2 cups crushed tomatoes", "3 cups chicken stock", "2 cups corn", "2 cups lima beans", "1/2 cup barbecue sauce", "1 tbsp Worcestershire"], ["Cook onion until soft.", "Add tomatoes, stock, corn, lima beans, barbecue sauce, and Worcestershire.", "Simmer until vegetables are tender.", "Stir in chicken and pork.", "Cook until thick and spoonable."], ["georgia", "brunswick stew", "church supper", "barbecue"]]
].map(([id, title, cuisine, category, image, prep_time, cook_time, difficulty, servings, description, ingredients, instructions, tags]) => ({
  id,
  title,
  slug: id,
...
const midwestPhotoReadyRecipeIds = new Set([
  ...
  "cleveland-pierogies",
  "goetta",
  "indiana-chicken-and-noodles",
  "jucy-lucy",
  "lefse",
  "midwest-dessert-bars",
  "pan-fried-walleye",
  "persimmon-pudding",
  "polish-boy",
  "sugar-cream-pie",
...
const recipeImageOverrides = {
  ...
  "chicago-hot-tamales": "images/recipes/audit-2026-06/chicago-hot-tamales.jpg",
  "chicago-mild-sauce": "images/recipes/audit-2026-06/chicago-mild-sauce.jpg",
  "chicago-polish-sausage": "images/recipes/audit-2026-06/chicago-polish-sausage.jpg",
  "chicago-pork-chop-sandwich": "images/recipes/audit-2026-06/chicago-pork-chop-sandwich.jpg",
  "chicago-rib-tips": "images/recipes/audit-2026-06/chicago-rib-tips.jpg",
  "chicago-style-hot-dog": "images/recipes/audit-2026-06/chicago-style-hot-dog.jpg",
  "chicken-vesuvio": "images/recipes/audit-2026-06/chicken-vesuvio.jpg",
  "deep-dish-pizza": "images/recipes/audit-2026-06/deep-dish-pizza.jpg",
  "detroit-style-pizza": "images/recipes/audit-2026-06/detroit-style-pizza.jpg",
  "gd-burger-gyro-meat": "images/recipes/audit-2026-06/gd-burger-gyro-meat.jpg",
  ...
  "italian-ice": "images/recipes/audit-2026-06/italian-ice.jpg",
  "jibarito": "images/recipes/audit-2026-06/jibarito.jpg",
  "maxwell-street-polish": "images/recipes/audit-2026-06/maxwell-street-polish.jpg",
  "pizza-puff": "images/recipes/audit-2026-06/pizza-puff.jpg",
  "rainbow-cone": "images/recipes/audit-2026-06/rainbow-cone.jpg",
  "shrimp-dejonghe": "images/recipes/audit-2026-06/shrimp-dejonghe.jpg",
  "tater-tot-hotdish": "images/recipes/audit-2026-06/tater-tot-hotdish.jpg",
  "tavern-style-thin-crust-pizza": "images/recipes/audit-2026-06/tavern-style-thin-crust-pizza.jpg",
  "beer-cheese-soup": "images/recipes/audit-2026-06/beer-cheese-soup.jpg",
  "great-lakes-whitefish": "images/recipes/audit-2026-06/great-lakes-whitefish.jpg",
  "michigan-cherry-pie": "images/recipes/audit-2026-06/michigan-cherry-pie.jpg",
  "michigan-coney-dogs": "images/recipes/audit-2026-06/michigan-coney-dogs.jpg",
  "paczki": "images/recipes/audit-2026-06/paczki.jpg",
  "upper-peninsula-pasties": "images/recipes/audit-2026-06/upper-peninsula-pasties.jpg",
  "wisconsin-brats": "images/recipes/audit-2026-06/wisconsin-brats.jpg",
  "wisconsin-butter-burgers": "images/recipes/audit-2026-06/wisconsin-butter-burgers.jpg",
  "wisconsin-cheese-curds": "images/recipes/audit-2026-06/wisconsin-cheese-curds.jpg",
  "wisconsin-friday-fish-fry": "images/recipes/audit-2026-06/wisconsin-friday-fish-fry.jpg",
  "wisconsin-kringle": "images/recipes/audit-2026-06/wisconsin-kringle.jpg",
  "breaded-pork-tenderloin-sandwich": "images/recipes/audit-2026-06/breaded-pork-tenderloin-sandwich.jpg",
  "buckeyes": "images/recipes/audit-2026-06/buckeyes.jpg",
  "cincinnati-chili": "images/recipes/audit-2026-06/cincinnati-chili.jpg",
  "cleveland-pierogies": "images/recipes/audit-2026-06/cleveland-pierogies.jpg",
  "goetta": "images/recipes/audit-2026-06/goetta.jpg",
  "indiana-chicken-and-noodles": "images/recipes/audit-2026-06/indiana-chicken-and-noodles.jpg",
  "jucy-lucy": "images/recipes/audit-2026-06/jucy-lucy.jpg",
  "lefse": "images/recipes/audit-2026-06/lefse.jpg",
  "midwest-dessert-bars": "images/recipes/audit-2026-06/midwest-dessert-bars.jpg",
  "pan-fried-walleye": "images/recipes/audit-2026-06/pan-fried-walleye.jpg",
  "persimmon-pudding": "images/recipes/audit-2026-06/persimmon-pudding.jpg",
  "polish-boy": "images/recipes/audit-2026-06/polish-boy.jpg",
  "sugar-cream-pie": "images/recipes/audit-2026-06/sugar-cream-pie.jpg",
  "wild-rice-soup": "images/recipes/audit-2026-06/wild-rice-soup.jpg",
  "dakota-kuchen": "images/recipes/audit-2026-06/dakota-kuchen.jpg",
  "gooey-butter-cake": "images/recipes/audit-2026-06/gooey-butter-cake.jpg",
  "iowa-corn-casserole": "images/recipes/audit-2026-06/iowa-corn-casserole.jpg",
  "iowa-pork-tenderloin-sandwich": "images/recipes/audit-2026-06/iowa-pork-tenderloin-sandwich.jpg",
  "kansas-burnt-ends": "images/recipes/audit-2026-06/kansas-burnt-ends.jpg",
  "kansas-chicken-fried-steak": "images/recipes/audit-2026-06/kansas-chicken-fried-steak.jpg",
  "kansas-city-bbq-sauce": "images/recipes/audit-2026-06/kansas-city-bbq-sauce.jpg",
  "kansas-city-burnt-ends": "images/recipes/audit-2026-06/kansas-city-burnt-ends.jpg",
  "kansas-city-ribs": "images/recipes/audit-2026-06/kansas-city-ribs.jpg",
  "kansas-city-smoked-sausage": "images/recipes/audit-2026-06/kansas-city-smoked-sausage.jpg",
  "knoephla-soup": "images/recipes/audit-2026-06/knoephla-soup.jpg",
  "kolaches": "images/recipes/audit-2026-06/kolaches.jpg",
  "maid-rite-loose-meat-sandwich": "images/recipes/audit-2026-06/maid-rite-loose-meat-sandwich.jpg",
  "nebraska-steak": "images/recipes/audit-2026-06/nebraska-steak.jpg",
  "northern-plains-fry-bread": "images/recipes/audit-2026-06/northern-plains-fry-bread.jpg",
  "rhubarb-pie": "images/recipes/audit-2026-06/rhubarb-pie.jpg",
  "runza": "images/recipes/audit-2026-06/runza.jpg",
  "south-dakota-chislic": "images/recipes/audit-2026-06/south-dakota-chislic.jpg",
  "st-louis-pork-steaks": "images/recipes/audit-2026-06/st-louis-pork-steaks.jpg",
  "st-louis-style-pizza": "images/recipes/audit-2026-06/st-louis-style-pizza.jpg",
  "toasted-ravioli": "images/recipes/audit-2026-06/toasted-ravioli.jpg",
  ...
  "white-perch-fry": "images/recipes/audit-2026-06/mississippi-perch-fry.jpg",
  "mississippi-bream-fry": "images/recipes/audit-2026-06/mississippi-bream-fry.jpg",
  "mississippi-crappie-fry": "images/recipes/audit-2026-06/mississippi-crappie-fry.jpg",
  "comeback-sauce": "images/recipes/audit-2026-06/comeback-sauce.jpg",
  "oyster-poboy": "images/recipes/audit-2026-06/oyster-poboy.jpg",
  "charbroiled-oysters": "images/recipes/audit-2026-06/charbroiled-oysters.jpg",
  "crawfish-boil": "images/recipes/audit-2026-06/crawfish-boil.jpg",
  "texas-smoked-sausage": "images/recipes/audit-2026-06/texas-smoked-sausage.jpg",
  "jalapeno-cheddar-sausage": "images/recipes/audit-2026-06/jalapeno-cheddar-sausage.jpg",
  "alabama-fried-green-tomatoes": "images/recipes/audit-2026-06/alabama-fried-green-tomatoes.jpg",
  "nashville-hot-chicken": "images/recipes/audit-2026-06/nashville-hot-chicken.jpg",
  "memphis-dry-rub-ribs": "images/recipes/audit-2026-06/memphis-dry-rub-ribs.jpg",
  "arkansas-fried-pickles": "images/recipes/audit-2026-06/arkansas-fried-pickles.jpg",
  "arkansas-delta-tamales": "images/recipes/audit-2026-06/arkansas-delta-tamales.jpg",
  "arkansas-chocolate-gravy-biscuits": "images/recipes/audit-2026-06/arkansas-chocolate-gravy-biscuits.jpg",
  "virginia-country-ham": "images/recipes/audit-2026-06/virginia-country-ham.jpg",
  "virginia-brunswick-stew": "images/recipes/audit-2026-06/virginia-brunswick-stew.jpg",
  "virginia-peanut-soup": "images/recipes/audit-2026-06/virginia-peanut-soup.jpg",
  "grouper-sandwich": "images/recipes/audit-2026-06/grouper-sandwich.jpg",
  "smoked-mullet": "images/recipes/audit-2026-06/smoked-mullet.jpg",
  "chicken-and-dumplings": "images/recipes/audit-2026-06/chicken-and-dumplings.jpg",
  "red-beans-and-rice": "images/recipes/audit-2026-06/red-beans-and-rice.jpg",
  "louisiana-boudin": "images/recipes/audit-2026-06/louisiana-boudin.jpg",
  "fried-oysters": "images/recipes/audit-2026-06/fried-oysters.jpg",
  "chicken-fried-steak": "images/recipes/audit-2026-06/chicken-fried-steak.jpg",
  "texas-kolaches": "images/recipes/audit-2026-06/texas-kolaches.jpg",
  "texas-pinto-beans": "images/recipes/audit-2026-06/texas-pinto-beans.jpg",
  "conch-fritters": "images/recipes/audit-2026-06/conch-fritters.jpg",
  "datil-pepper-sauce": "images/recipes/audit-2026-06/datil-pepper-sauce.jpg",
  "tennessee-chess-pie": "images/recipes/audit-2026-06/tennessee-chess-pie.jpg",
  "virginia-spoon-bread": "images/recipes/audit-2026-06/virginia-spoon-bread.jpg",
  "carolina-vinegar-sauce": "images/recipes/audit-2026-06/carolina-vinegar-sauce.jpg",
  "carolina-red-rice": "images/recipes/audit-2026-06/carolina-red-rice.jpg",
  "gullah-geechee-favorites": "images/recipes/audit-2026-06/gullah-geechee-favorites.jpg",
  "vidalia-onion-pie": "images/recipes/audit-2026-06/vidalia-onion-pie.jpg",
  "georgia-brunswick-stew": "images/recipes/audit-2026-06/georgia-brunswick-stew.jpg",
  "chicken-rice-casserole": "images/recipes/audit-2026-06/chicken-rice-casserole.jpg",
  "broccoli-rice-casserole": "images/recipes/audit-2026-06/broccoli-rice-casserole.jpg",
  "squash-casserole": "images/recipes/audit-2026-06/squash-casserole.jpg",
  "sweet-potato-casserole": "images/recipes/audit-2026-06/sweet-potato-casserole.jpg",
  "green-bean-casserole": "images/recipes/audit-2026-06/green-bean-casserole.jpg",
  "corn-casserole": "images/recipes/audit-2026-06/corn-casserole.jpg",
  "hashbrown-casserole": "images/recipes/audit-2026-06/hashbrown-casserole.jpg",
  "mexican-cornbread-casserole": "images/recipes/audit-2026-06/mexican-cornbread-casserole.jpg",
  "crawfish-cornbread-casserole": "images/recipes/audit-2026-06/crawfish-cornbread-casserole.jpg",
  "king-ranch-chicken": "images/recipes/audit-2026-06/king-ranch-chicken.jpg",
  "chicken-spaghetti": "images/recipes/audit-2026-06/chicken-spaghetti.jpg",
  "funeral-potatoes": "images/recipes/audit-2026-06/funeral-potatoes.jpg",
  "ambrosia-salad": "images/recipes/audit-2026-06/ambrosia-salad.jpg",
  "watergate-salad": "images/recipes/audit-2026-06/watergate-salad.jpg",
  "seven-layer-salad": "images/recipes/audit-2026-06/seven-layer-salad.jpg",
  "grape-salad": "images/recipes/audit-2026-06/grape-salad.jpg",
  "corn-salad": "images/recipes/audit-2026-06/corn-salad.jpg",
  "pea-salad": "images/recipes/audit-2026-06/pea-salad.jpg",
  "baked-ham": "images/recipes/audit-2026-06/baked-ham.jpg",
  "moroccan-carrot-salad": "images/recipes/audit-2026-06/moroccan-carrot-salad.jpg",
  "indian-dal-tadka": "images/recipes/audit-2026-06/indian-dal-tadka.jpg",
  "grilled-swordfish-lemon-herb": "images/recipes/audit-2026-06/grilled-swordfish-lemon-herb.jpg",
  "swordfish-tacos": "images/recipes/audit-2026-06/swordfish-tacos.jpg",
  "mediterranean-swordfish": "images/recipes/audit-2026-06/mediterranean-swordfish.jpg",
  "garlic-butter-swordfish": "images/recipes/audit-2026-06/garlic-butter-swordfish.jpg",
  "greek-salad": "images/recipes/audit-2026-06/greek-salad.jpg",
  "creamy-hummus": "images/recipes/audit-2026-06/creamy-hummus.jpg",
  "roasted-vegetables": "images/recipes/audit-2026-06/roasted-vegetables.jpg",
  "rice-pilaf": "images/recipes/audit-2026-06/rice-pilaf.jpg",
  "bbq-brisket-basics": "images/juneteenth/smoked-sliced-brisket.png",
  "bbq-chicken-quarters": "images/juneteenth/bbq-chicken-quarters.png",
  "bbq-baked-beans": "images/juneteenth/bbq-baked-beans.png",
  "southern-collard-greens": "images/juneteenth/southern-collard-greens.png",
  "cornbread": "images/juneteenth/cast-iron-skillet-cornbread.png",
  "strawberry-soda": "images/juneteenth/strawberry-soda.png",
  "watermelon-platter": "images/juneteenth/watermelon-platter.png",
  "red-velvet-cake": "images/juneteenth/red-velvet-cake.png",
  "peach-cobbler": "images/juneteenth/peach-cobbler.png",
  "creamy-coleslaw": "images/juneteenth/creamy-coleslaw.png",
  "southern-potato-salad": "images/juneteenth/southern-potato-salad.png",
  ...
  "charbroiled-oysters": "assets/lc-seafood.jpg",
  "beignets": "images/regional/beignets.png",
  "crawfish-boil": "assets/lc-seafood.jpg",
  "texas-beef-ribs": "images/regional/texas-beef-ribs.png",
  "texas-chili": "images/regional/texas-chili.png",
  "texas-smoked-sausage": "images/regional/texas-beef-ribs.png",
  "jalapeno-cheddar-sausage": "images/regional/texas-beef-ribs.png",
  "alabama-white-sauce-chicken": "images/regional/alabama-white-sauce-chicken.png",
  "alabama-pulled-pork-sandwiches": "images/juneteenth/pulled-pork-shoulder.png",
  "alabama-fried-green-tomatoes": "images/cuisines/southern/southern-01.png",
  "nashville-hot-chicken": "images/cuisines/southern/southern-01.png",
  "memphis-dry-rub-ribs": "images/regional/texas-beef-ribs.png",
  "memphis-bbq-spaghetti": "assets/lc-pasta.jpg",
  "arkansas-fried-pickles": "images/cuisines/southern/southern-01.png",
  "arkansas-delta-tamales": "assets/lc-birria-tacos.jpg",
  "arkansas-chocolate-gravy-biscuits": "images/cuisines/southern/southern-05.png",
  "frogmore-stew": "images/regional/frogmore-stew.png",
  "hoppin-john": "images/regional/hoppin-john.png",
  "eastern-nc-bbq": "images/juneteenth/pulled-pork-shoulder.png",
  "lexington-bbq": "images/juneteenth/pulled-pork-shoulder.png",
  "virginia-country-ham": "images/cuisines/southern/southern-05.png",
  "virginia-brunswick-stew": "assets/american-food.jpeg",
  "virginia-peanut-soup": "assets/ingredients.jpeg",
  "key-lime-pie": "images/regional/key-lime-pie.png",
  "stone-crab-claws": "images/regional/stone-crab.png",
  "florida-blue-crab": "images/regional/stone-crab.png",
  "grouper-sandwich": "assets/lc-seafood.jpg",
...
const auditedRecipeImageIds = [
  "smothered-pork-chops", "sweet-tea", "mississippi-perch-fry", "mississippi-bream-fry",
  "mississippi-crappie-fry", "comeback-sauce", "oyster-poboy", "charbroiled-oysters",
  "crawfish-boil", "texas-smoked-sausage", "jalapeno-cheddar-sausage", "alabama-fried-green-tomatoes",
  "nashville-hot-chicken", "memphis-dry-rub-ribs", "arkansas-fried-pickles", "arkansas-delta-tamales",
  "arkansas-chocolate-gravy-biscuits", "virginia-country-ham", "virginia-brunswick-stew",
  "virginia-peanut-soup", "grouper-sandwich", "smoked-mullet", "chicken-and-dumplings",
  "red-beans-and-rice", "louisiana-boudin", "fried-oysters", "chicken-fried-steak",
  "texas-kolaches", "texas-pinto-beans", "conch-fritters", "datil-pepper-sauce",
  "tennessee-chess-pie", "virginia-spoon-bread", "carolina-vinegar-sauce", "carolina-red-rice",
  "gullah-geechee-favorites", "vidalia-onion-pie", "georgia-brunswick-stew", "chicken-rice-casserole",
  "broccoli-rice-casserole", "squash-casserole", "sweet-potato-casserole", "green-bean-casserole",
  "corn-casserole", "hashbrown-casserole", "mexican-cornbread-casserole",
  "crawfish-cornbread-casserole", "king-ranch-chicken", "chicken-spaghetti", "funeral-potatoes",
  "ambrosia-salad", "watergate-salad", "seven-layer-salad", "grape-salad", "corn-salad",
  "pea-salad", "baked-ham", "moroccan-carrot-salad", "indian-dal-tadka",
  "grilled-swordfish-lemon-herb", "swordfish-tacos", "mediterranean-swordfish",
  "garlic-butter-swordfish", "greek-salad", "creamy-hummus", "roasted-vegetables", "rice-pilaf"
];

auditedRecipeImageIds.forEach((recipeId) => {
...
const broadRecipeImageIds = [
  ...
  "cabbage-saute", "cucumber-salad", "corn-on-the-cob", "smothered-green-beans",
  "corn-maque-choux", "okra-tomato-stew", "green-salad", "buttered-vegetables",
  "black-bean-side", "elote-corn", "mexican-slaw", "apple-nachos",
  "ants-on-a-log", "berry-banana-smoothies", "trail-mix-jars", "breakfast-egg-cups",
  "smoothie-cups", "breakfast-casserole", "loaded-baked-potato-soup", "soft-scrambled-eggs",
  "yakamein", "oxtails", "crab-rangoon", "charcuterie-boards",
  "roasted-vegetable-tray", "rotel-dip", "party-meatballs", "lamb-bone-broth-soup",
  "tartar-sauce", "southern-gravy", "jerk-sauce", "tzatziki-sauce",
  "bbq-sauce-trio", "creole-seasoning-blend", "salsa-roja", "salsa-verde",
  "pickled-red-onions", "charcuterie-cups", "general-tso-chicken", "cajun-cream-pasta",
  "memphis-bbq-spaghetti", "white-chicken-chili", "tuscan-chicken", "sorrel-drink",
  "mint-lemonade", "agua-fresca", "brunch-cups", "pineapple-fried-rice",
  "cajun-jambalaya", "cajun-dirty-rice", "white-rice", "cilantro-lime-rice",
  "shrimp-fried-rice", "vegetable-stir-fry", "creole-bananas-foster", "pound-cake",
  "rum-cake", "baklava-cups", "kheer", "churro-bites",
  "flan-cups", "yogurt-parfait-cups", "chewy-chocolate-cookies", "banana-pudding-cups",
  "crispy-rice-treats", "no-bake-cereal-bars", "fruit-cups", "dessert-cups",
  "holiday-cups", "blackened-fish", "cajun-chicken-sausage-gumbo", "cajun-shrimp-etouffee",
  "creole-shrimp-creole", "creole-seafood-gumbo", "creole-courtbouillon", "garlic-wings",
  "mini-chicken-sliders", "baked-chicken-tenders", "smothered-chicken", "lemon-pepper-wings",
  "tandoori-chicken", "butter-chicken", "chicken-tikka-masala", "biryani",
  "palak-paneer", "chana-masala", "garlic-naan", "dinner-rolls",
  "coco-bread", "pita-flatbread", "slider-buns", "french-bread",
  "corn-tortillas", "nigerian-fried-rice", "nigerian-pepper-soup", "ghanaian-jollof-rice",
  "ethiopian-shiro-wat", "ethiopian-kik-alicha", "rice-and-peas", "cucumber-raita",
  "kachumber-salad", "mint-chutney", "mango-lassi", "birria-style-tacos",
  "taco-cups", "sheet-pan-nachos", "taco-soup", "beef-tacos",
  "chicken-quesadillas", "mac-and-cheese-bites", "simple-spaghetti", "baked-spaghetti",
  "chicken-alfredo", "hamburger-steak-with-gravy", "baked-pork-chops", "orange-chicken",
  "cashew-chicken", "chicken-parmesan", "southern-cornbread-dressing", "southern-buttermilk-biscuits"
];

broadRecipeImageIds.forEach((recipeId) => {
  recipeImageOverrides[recipeId] = `images/recipes/audit-2026-06/${recipeId}.jpg`;
});
Object.assign(recipeImageOverrides, {
  "stovetop-mac-and-cheese": "images/recipes/audit-2026-06/stovetop-mac-and-cheese.jpg",
  "bourbon-praline-bread-pudding": "images/recipes/audit-2026-06/bourbon-praline-bread-pudding.jpg",
  "candied-yams": "images/recipes/audit-2026-06/candied-yams.jpg",
  "florida-blue-crab": "images/recipes/audit-2026-06/florida-blue-crab.jpg",
  "blackened-swordfish": "images/recipes/audit-2026-06/blackened-swordfish.jpg",
  ...
  "eastern-nc-bbq": "images/recipes/audit-2026-06/eastern-nc-bbq.jpg",
  "lexington-bbq": "images/recipes/audit-2026-06/lexington-bbq.jpg"
});
...
const regionalSoulFoodPages = {
  ...
  "louisiana-soul-food": {
    ...
    signatureRecipeIds: ["cajun-chicken-sausage-gumbo", "cajun-shrimp-etouffee", "cajun-jambalaya", "red-beans-and-rice", "louisiana-boudin", "shrimp-poboy", "oyster-poboy", "muffuletta", "charbroiled-oysters", "fried-oysters", "crawfish-boil", "cajun-dirty-rice", "creole-seafood-gumbo", "beignets", "bourbon-praline-bread-pudding", "creole-bananas-foster"],
  ...
  "georgia-soul-food": {
    ...
    signatureRecipeIds: ["fried-chicken", "southern-collard-greens", "cornbread", "peach-cobbler", "vidalia-onion-pie", "georgia-brunswick-stew", "bbq-smoked-ribs", "banana-pudding", "southern-potato-salad"],
  ...
  "alabama-soul-food": {
    ...
    signatureRecipeIds: ["alabama-white-sauce-chicken", "alabama-pulled-pork-sandwiches", "alabama-fried-green-tomatoes", "fried-chicken", "southern-collard-greens", "cornbread", "banana-pudding", "peach-cobbler", "southern-baked-mac-cheese"],
  ...
  "south-carolina-soul-food": {
    ...
    signatureRecipeIds: ["shrimp-and-grits", "hoppin-john", "frogmore-stew", "carolina-red-rice", "gullah-geechee-favorites", "southern-collard-greens", "cornbread", "bbq-pulled-pork", "red-velvet-cake", "sweet-tea"],
  ...
  "tennessee-soul-food": {
    ...
    signatureRecipeIds: ["nashville-hot-chicken", "memphis-dry-rub-ribs", "memphis-bbq-spaghetti", "bbq-pulled-pork", "tennessee-chess-pie", "southern-potato-salad", "creamy-coleslaw", "banana-pudding", "sweet-tea"],
  ...
  "texas-soul-food": {
    ...
    signatureRecipeIds: ["bbq-brisket-basics", "texas-beef-ribs", "texas-smoked-sausage", "jalapeno-cheddar-sausage", "texas-chili", "chicken-fried-steak", "texas-kolaches", "texas-pinto-beans", "bbq-chicken-quarters", "bbq-baked-beans", "cornbread", "watermelon-platter", "red-velvet-cake", "strawberry-soda"],
  ...
  "florida-soul-food": {
    ...
    signatureRecipeIds: ["florida-blue-crab", "stone-crab-claws", "grouper-sandwich", "smoked-mullet", "cuban-sandwich", "key-lime-pie", "conch-fritters", "datil-pepper-sauce", "lemonade", "cucumber-salad", "watermelon-platter"],
    ...
    features: [["Coastal Seafood Table", "Blue crab, stone crab, grouper, smoked mullet, lemon, cold salads, and iced drinks."], ["Miami Cafe Plate", "Cuban sandwich, pickles, plantain chips, and key lime pie."]],
    menus: []
  },
  ...
  "virginia-soul-food": {
    ...
    signatureRecipeIds: ["virginia-country-ham", "virginia-brunswick-stew", "virginia-peanut-soup", "virginia-spoon-bread", "smothered-pork-chops", "fried-chicken", "southern-collard-greens", "cornbread", "peach-cobbler", "buttermilk-biscuits", "sweet-tea"],
  ...
  "arkansas-soul-food": {
    ...
    signatureRecipeIds: ["fried-catfish", "arkansas-fried-pickles", "arkansas-delta-tamales", "arkansas-chocolate-gravy-biscuits", "fried-chicken", "southern-collard-greens", "cornbread", "bbq-pulled-pork", "peach-cobbler", "sweet-tea"],
...
const regionalMenuOverrides = {
  "mississippi-soul-food": [
    { id: "fish-fry", title: "Mississippi Fish Fry", recipeIds: ["mississippi-fish-fry-plate", "fried-catfish", "mississippi-buffalo-fish", "white-perch-fry", "mississippi-bream-fry", "mississippi-crappie-fry", "comeback-sauce", "hot-water-cornbread", "creamy-coleslaw", "southern-potato-salad", "sweet-tea", "peach-cobbler"], timeline: ["Morning: cut fish, mix slaw, and chill drinks.", "One hour before: season fish, heat oil, and set racks.", "Serve: fry fish in batches and keep sides cold."], notes: "Build the plate around hot cornmeal-crusted fish, cold sides, comeback sauce, hot sauce, lemon, bread, and plenty of napkins." },
    { id: "sunday-dinner", title: "Mississippi Sunday Dinner", recipeIds: ["fried-chicken", "smothered-pork-chops", "chicken-and-dumplings", "turnip-greens", "mississippi-butter-beans", "cornbread", "southern-baked-mac-cheese", "sweet-tea", "caramel-cake"], timeline: ["Morning: season meat and wash greens.", "Two hours before: start greens and dessert table.", "Last hour: fry chicken, finish gravy, bake cornbread, and set tea."], notes: "This table should feel like gospel after church: greens, cornbread, gravy, dessert, and time to sit down." },
  ...
  "louisiana-soul-food": [
    { id: "gumbo-night", title: "Gumbo Night", recipeIds: ["cajun-chicken-sausage-gumbo", "red-beans-and-rice", "white-rice", "french-bread", "green-salad", "sweet-tea", "beignets"], timeline: ["Morning: chop trinity and make dessert dough.", "Two hours before: build roux and simmer gumbo.", "Serve: keep rice separate and bread warm."], notes: "Let the gumbo pot lead. Rice, bread, beans, and something sweet make it feel complete." },
    { id: "new-orleans-table", title: "New Orleans Table", recipeIds: ["shrimp-poboy", "oyster-poboy", "muffuletta", "charbroiled-oysters", "fried-oysters", "beignets", "lemonade"], timeline: ["Day before: make olive salad and sauces.", "One hour before: prep shrimp, oysters, and sandwich fillings.", "Serve: fry seafood last and cut muffuletta into wedges."], notes: "This menu should feel portable, festive, briny, and good for second-line energy." },
    { id: "crawfish-boil", title: "Backyard Crawfish Boil", recipeIds: ["crawfish-boil", "louisiana-boudin", "corn-maque-choux", "french-bread", "beignets", "sweet-tea"], timeline: ["Morning: purge crawfish and stage potatoes, corn, sausage, and lemons.", "One hour before: bring the boil pot to a rolling boil.", "Serve: drain, spread the table, and keep drinks cold."], notes: "A crawfish boil is a whole-table event: seafood, seasoning, music, newspaper, napkins, and people standing around the pot." },
    { id: "cajun-rice-supper", title: "Cajun Rice Supper", recipeIds: ["cajun-jambalaya", "cajun-dirty-rice", "red-beans-and-rice", "smothered-green-beans", "corn-maque-choux", "french-bread", "bourbon-praline-bread-pudding"], timeline: ["Morning: prep trinity and sausage.", "Afternoon: cook dessert and side vegetables.", "Last hour: finish rice dishes and hold covered."], notes: "Rice dishes need timing and rest. Keep bread nearby and do not rush the pot." }
  ],
  "alabama-soul-food": [
    { id: "white-sauce-bbq", title: "White Sauce BBQ Plate", recipeIds: ["alabama-white-sauce-chicken", "alabama-pulled-pork-sandwiches", "alabama-fried-green-tomatoes", "creamy-coleslaw", "bbq-baked-beans", "cornbread", "banana-pudding"], timeline: ["Morning: season chicken and pork.", "Two hours before: prep sides and sauce.", "Serve: grill chicken last and pass extra white sauce."], notes: "Alabama flavor shows up in tangy white sauce, smoke, slaw, beans, fried green tomatoes, and a cool dessert." },
    { id: "church-supper", title: "Alabama Church Supper", recipeIds: ["fried-chicken", "alabama-fried-green-tomatoes", "southern-collard-greens", "southern-baked-mac-cheese", "cornbread", "sweet-tea", "peach-cobbler"], timeline: ["Day before: bake dessert and prep greens.", "Morning: cook sides in travel pans.", "Before serving: fry chicken or warm covered trays."], notes: "Choose sturdy pans, clear labels, and foods that hold with dignity." }
  ],
  "south-carolina-soul-food": [
    { id: "lowcountry-boil", title: "Lowcountry Boil", recipeIds: ["frogmore-stew", "hoppin-john", "carolina-red-rice", "southern-collard-greens", "cornbread", "sweet-tea", "red-velvet-cake"], timeline: ["Morning: clean shrimp and cut sausage.", "One hour before: boil potatoes, corn, and sausage.", "Serve: add shrimp last and spread the table family-style."], notes: "Frogmore Stew should be communal: seafood, sausage, corn, potatoes, rice, sauce, and lots of hands." },
    { id: "gullah-geechee-supper", title: "Gullah Geechee Supper", recipeIds: ["gullah-geechee-favorites", "shrimp-and-grits", "hoppin-john", "carolina-red-rice", "okra-tomato-stew", "southern-collard-greens", "cornbread", "sweet-tea"], timeline: ["Morning: prep rice, peas, and greens.", "Two hours before: start Hoppin' John.", "Last hour: cook shrimp and grits close to service."], notes: "Rice, seafood, okra, greens, and grits should tell the Lowcountry story." }
  ],
  "texas-soul-food": [
    { id: "pitmaster-plate", title: "Texas Pitmaster Plate", recipeIds: ["bbq-brisket-basics", "texas-beef-ribs", "texas-smoked-sausage", "jalapeno-cheddar-sausage", "texas-pinto-beans", "bbq-baked-beans", "cornbread", "watermelon-platter", "strawberry-soda"], timeline: ["Day before: season brisket and ribs.", "Sunrise: start the smoker.", "Before serving: rest meat, warm sausage, slice brisket, and set drinks in ice."], notes: "Texas barbecue is patience: smoke, bark, rest, slicing, sausage links, beans, bread, and shade." },
    { id: "juneteenth-cookout", title: "Texas Juneteenth Cookout", recipeIds: ["bbq-brisket-basics", "bbq-chicken-quarters", "texas-chili", "chicken-fried-steak", "texas-kolaches", "cornbread", "red-velvet-cake", "strawberry-soda", "watermelon-platter"], timeline: ["Day before: bake cake and chill red drinks.", "Morning: start brisket and chili.", "Afternoon: grill chicken, warm sausage, slice watermelon, and set the table."], notes: "Keep the Juneteenth table family-centered: smoke, red foods, watermelon, music, and room to gather." }
  ],
  "tennessee-soul-food": [
    { id: "memphis-bbq", title: "Memphis BBQ Table", recipeIds: ["memphis-dry-rub-ribs", "bbq-pulled-pork", "memphis-bbq-spaghetti", "creamy-coleslaw", "bbq-baked-beans", "tennessee-chess-pie", "sweet-tea"], timeline: ["Day before: rub ribs and cook pork if needed.", "Morning: make slaw and pie.", "Before serving: finish ribs, warm BBQ spaghetti, and set sauce on the side."], notes: "Memphis should taste like smoke, dry rub, pork, slaw, beans, music, and sauce passed at the table." },
    { id: "nashville-hot-supper", title: "Nashville Hot Supper", recipeIds: ["nashville-hot-chicken", "southern-potato-salad", "creamy-coleslaw", "cornbread", "sweet-tea", "tennessee-chess-pie"], timeline: ["Morning: marinate chicken and chill sides.", "One hour before: dredge chicken and heat oil.", "Serve: brush hot oil last and keep pickles and bread ready."], notes: "This table is spicy, crisp, cooling, and built for music-night energy." }
  ],
  "arkansas-soul-food": [
    { id: "delta-fish-fry", title: "Arkansas Delta Fish Fry", recipeIds: ["fried-catfish", "arkansas-fried-pickles", "cornbread", "creamy-coleslaw", "southern-potato-salad", "sweet-tea", "peach-cobbler"], timeline: ["Morning: make slaw, potato salad, and cobbler.", "One hour before: drain pickles, season fish, and heat oil.", "Serve: fry pickles first, fish second, and keep sides cold."], notes: "Arkansas Delta plates need hot cornmeal-crusted fish, crisp pickles, cold sides, bread, tea, and a crowd." },
    { id: "delta-reunion", title: "Arkansas Delta Reunion", recipeIds: ["arkansas-delta-tamales", "bbq-pulled-pork", "southern-collard-greens", "cornbread", "arkansas-chocolate-gravy-biscuits", "strawberry-soda"], timeline: ["Day before: prep tamales and greens.", "Morning: warm pulled pork and bake biscuits.", "Serve: hold tamales warm, set greens and bread together, and put drinks on ice."], notes: "This menu connects Delta tamales, barbecue, greens, cornbread, sweet breakfast memory, and reunion hospitality." }
  ],
  "georgia-soul-food": [
    { id: "peach-state-supper", title: "Georgia Peach State Supper", recipeIds: ["fried-chicken", "vidalia-onion-pie", "georgia-brunswick-stew", "southern-collard-greens", "cornbread", "peach-cobbler", "sweet-tea"], timeline: ["Morning: start stew and prep cobbler.", "Two hours before: cook greens and Vidalia pie.", "Last hour: fry chicken, bake cornbread, and set tea."], notes: "Georgia should taste like sweet onions, peaches, greens, chicken, stew, and a table that lingers." },
    { id: "coastal-georgia-table", title: "Coastal Georgia Table", recipeIds: ["shrimp-and-grits", "hoppin-john", "carolina-red-rice", "vidalia-onion-pie", "cucumber-salad", "lemonade"], timeline: ["Morning: prep rice and onions.", "One hour before: cook grits and sides.", "Serve: saute shrimp close to the table and keep drinks cold."], notes: "This menu points toward coastal rice culture, shrimp, onions, and warm-weather hospitality." }
  ],
  "florida-soul-food": [
    { id: "coastal-seafood-table", title: "Florida Coastal Seafood Table", recipeIds: ["florida-blue-crab", "stone-crab-claws", "grouper-sandwich", "smoked-mullet", "conch-fritters", "datil-pepper-sauce", "cucumber-salad", "lemonade", "key-lime-pie"], timeline: ["Morning: chill crab and make sauce.", "One hour before: prep salad, sandwiches, and drinks.", "Serve: keep seafood cold, press or fry sandwiches hot, and keep dessert chilled."], notes: "Florida seafood menus need crab, fish, conch, citrus, crisp sides, cold drinks, and light desserts." },
    { id: "miami-cafe-plate", title: "Miami Cafe Plate", recipeIds: ["cuban-sandwich", "stone-crab-claws", "conch-fritters", "datil-pepper-sauce", "cucumber-salad", "mint-lemonade", "key-lime-pie"], timeline: ["Morning: make dessert and chill drinks.", "One hour before: assemble sandwiches.", "Serve: press sandwiches hot and keep seafood cold."], notes: "Cuban bread, citrus, seafood, datil heat, and cold drinks give this table its Florida identity." }
  ],
  "north-carolina-soul-food": [
    { id: "eastern-bbq", title: "Eastern North Carolina BBQ Plate", recipeIds: ["eastern-nc-bbq", "carolina-vinegar-sauce", "carolina-hush-puppies", "creamy-coleslaw", "cornbread", "southern-collard-greens", "banana-pudding", "sweet-tea"], timeline: ["Day before: season pork and prep slaw.", "Morning: smoke or roast pork low and slow.", "Serve: chop pork, dress with vinegar sauce, and keep slaw cold."], notes: "Eastern North Carolina should taste like chopped pork, vinegar-pepper sauce, slaw, hush puppies, greens, bread, and tea." },
    { id: "lexington-plate", title: "Lexington BBQ Plate", recipeIds: ["lexington-bbq", "carolina-vinegar-sauce", "carolina-hush-puppies", "creamy-coleslaw", "bbq-baked-beans", "cornbread", "peach-cobbler", "sweet-tea"], timeline: ["Day before: make slaw and dessert.", "Morning: cook pork shoulder.", "Serve: chop pork, pass red dip, and set sides in sturdy bowls."], notes: "Lexington-style plates lean into pork shoulder, red vinegar dip, slaw, beans, hush puppies, and dessert." }
  ],
  "virginia-soul-food": [
    { id: "tidewater-table", title: "Virginia Tidewater Table", recipeIds: ["virginia-country-ham", "virginia-brunswick-stew", "virginia-spoon-bread", "southern-collard-greens", "buttermilk-biscuits", "sweet-tea", "peach-cobbler"], timeline: ["Morning: start stew and prep greens.", "One hour before: warm ham and bake biscuits.", "Serve: keep stew hot and biscuits covered."], notes: "Virginia should feel steady: ham biscuits, thick stew, spoon bread, greens, tea, and a dessert that travels." },
    { id: "historic-comfort", title: "Virginia Comfort Supper", recipeIds: ["virginia-peanut-soup", "smothered-pork-chops", "virginia-spoon-bread", "southern-collard-greens", "cornbread", "buttermilk-biscuits", "sweet-tea"], timeline: ["Morning: prep soup base and wash greens.", "Two hours before: start greens and season pork chops.", "Serve: simmer soup gently, finish gravy, and bring bread hot."], notes: "Peanut soup, spoon bread, gravy, greens, and bread give this table its Virginia identity." }
  ]
};
    ...
    <section class="monthly-spotlight-banner juneteenth-banner">
      <div class="monthly-copy">
        <div class="juneteenth-homecoming-label">
          ...
          <span>${monthlySpotlight.month} 19th Family Reunion</span>
        </div>
        <h1>${monthlySpotlight.headline}</h1>
        <p>${monthlySpotlight.subhead}</p>
        <p class="reunion-welcome-line">Come on over. We saved you a plate.</p>
...
function thisMonthsTableSection() {
  const tableRecipes = monthlySpotlight.favoriteRecipeIds.map(recipeByIdSafe).filter(Boolean);
  return `
    <section class="cream-section reunion-table-section">
      ...
      <div class="reunion-table-spread">
        ${tableRecipes.map((recipe, index) => `
          <a class="reunion-dish-card dish-${index + 1}" href="#recipes/${recipe.id}">
            <img src="${recipePhotoFor(recipe)}" alt="${recipe.title}" />
...
function familyReunionSeasonSection() {
  const plans = [
    ["Reunion Menu Builder", menuRouteForOccasion("Juneteenth"), "Start with a full Juneteenth table and adjust the menu for your people."],
    ["Feed 25", "#hosting/family-reunion", "Small reunion, big love: one smoker main, three sides, fruit, dessert, drinks."],
    ["Feed 50", "#hosting/family-reunion", "Use stations, foil pans, cooler drinks, and assigned family helpers."],
    ["Feed 100", "#hosting/catering-prep", "Think in batches, holding temps, serving flow, refills, and cleanup crews."],
    ["Potluck Planner", "#hosting/church-potluck", "Assign mains, sides, desserts, drinks, paper goods, and serving spoons."],
    ["Shopping Lists", "#planner", "Turn the menu into ingredients, prep lists, and timing notes."]
  ];
  return `
    <section class="gold-section family-reunion-season">
      <div class="section-heading">
  ...
  return `
    <section class="cream-section red-foods-section">
      <div class="section-heading">
        ...
        <h2>Cold red drinks, cake slices, watermelon, and memory.</h2>
        <p>On Juneteenth tables, red foods are celebration food: sweet, bright, shared, and tied to resilience, remembrance, and the joy of finally gathering free.</p>
      </div>
  ...
  return `
    <section class="navy-section music-culture-section">
      <div class="section-heading">
        ...
        <h2>Somebody put the music on while the grill is going.</h2>
        <p>Mississippi blues, church gospel, soul, jazz, R&B, and hip-hop all carry food memories: porch songs, family reunion playlists, card-table laughter, and kitchens where somebody is stirring while somebody else is singing.</p>
      </div>
      <div class="music-culture-grid">
        ${[
          ["Blues", "Mississippi roots, BBQ smoke, Delta stories, and grown folks talking under the tent."],
          ["Gospel", "Sunday dinner, church homecomings, choir songs, greens, cornbread, and sweet tea."],
          ["Soul", "Family plates, slow dances, porch memories, and dessert after everybody eats."],
          ["Jazz", "Louisiana tables, second-line joy, gumbo pots, and celebration food."],
          ["R&B", "Cookout playlists, cousins laughing, and strawberry soda sweating in the cooler."],
          ["Hip-Hop", "Block parties, reunion shirts, grill smoke, and young folks bringing new energy."]
        ].map(([genre, text]) => `<article><span>${genre}</span><p>${text}</p></article>`).join("")}
      </div>
    </section>
  `;
}

function pullUpAChairSection() {
  return `
    <section class="cream-section pull-up-chair-section" id="pull-up-chair">
      ...
      <div class="chair-story-grid">
        ${[
          ["The Plate Saved For You", "Hospitality means somebody thought about you before you arrived."],
          ["Domino Table Talk", "Food, music, jokes, and family stories are all part of the menu."],
          ["Church Homecoming", "Covered dishes, red punch, serving spoons, and elders getting served first."],
          ["Sunday Dinner Memory", "Greens, cornbread, fried chicken, tea, dessert, and time to sit down."]
...
function shayKitchenData() {
  const personal = personalRecipes();
  const fallbackIds = ["smothered-chicken", "shrimp-and-grits", "orange-chicken", "white-chicken-chili", "baked-spaghetti", "banana-pudding"];
  const featured = personal.length
    ? personal
    : fallbackIds.map(recipeByIdSafe).filter(Boolean);
  const categories = [
    {
...
function shayKitchenSectionMarkup({ includeCategories = true } = {}) {
  const { featured, categories } = shayKitchenData();
  return `
...
function renderKitchen() {
  const { featured } = shayKitchenData();
  app.innerHTML = `
    ${hero(
      "Shay's Recipes",
      ...
      recipePhotoFor(featured[0] || recipes[0]),
